...
mongo_interned_names mongo_interned_names_list[] =
{
	{ ZEND_STRS("_id"), NULL },
	{ ZEND_STRS("type"), NULL },
	{ ZEND_STRS("level"), NULL },
	{ ZEND_STRS("timestamp"), NULL },
	{ ZEND_STRS("capacity"), NULL },
	{ ZEND_STRS("cost"), NULL },
	{ ZEND_STRS("time"), NULL },
	{ ZEND_STRS("amber"), NULL },
	{ ZEND_STRS("iron"), NULL },
	{ ZEND_STRS("lumber"), NULL },
	{ ZEND_STRS("column"), NULL },
	{ ZEND_STRS("row"), NULL },
	{ ZEND_STRS("revenged"), NULL },
	{ ZEND_STRS("fieldType"), NULL },
	{ ZEND_STRS("notified"), NULL },
	{ ZEND_STRS("attack"), NULL },
	{ ZEND_STRS("defense"), NULL },
	{ ZEND_STRS("chest"), NULL },
	{ ZEND_STRS("list"), NULL },
	{ ZEND_STRS("currentType"), NULL },
	{ ZEND_STRS("subType"), NULL },
	{ ZEND_STRS("family"), NULL },
	{ ZEND_STRS("session"), NULL },
	{ ZEND_STRS("egg"), NULL },
	{ ZEND_STRS("xp"), NULL },
	{ ZEND_STRS("x"), NULL },
	{ ZEND_STRS("y"), NULL },
	{ ZEND_STRS("completionPercentage"), NULL },
	{ ZEND_STRS("troopsSummoningQueue"), NULL },
	{ ZEND_STRS("buildTimeInSeconds"), NULL },
	{ ZEND_STRS("xPAfterBuilding"), NULL },
	{ ZEND_STRS("mainBuildingLevelRequired"), NULL },
	{ ZEND_STRS("askForGizmoCooldown"), NULL },
	{ ZEND_STRS("buildingType"), NULL },
	{ ZEND_STRS("troopsCapacity"), NULL },
	{ ZEND_STRS("upgradeCost"), NULL },
	{ ZEND_STRS("upgradeTime"), NULL },
	{ ZEND_STRS("summoningResourceType"), NULL },
	{ ZEND_STRS("upgradeResourceType"), NULL },
	{ ZEND_STRS("removalCostResourceType"), NULL },
	{ ZEND_STRS("hitPoints"), NULL },
	{ ZEND_STRS("elapsedTimeInSeconds"), NULL },
	{ ZEND_STRS("internalSubtype"), NULL },
	{ ZEND_STRS("timeGate"), NULL },
	{ ZEND_STRS("message"), NULL },
	{ ZEND_STRS("wasRead"), NULL },
	{ ZEND_STRS("wasClaimed"), NULL },
	{ ZEND_STRS("creationDate"), NULL },
	{ ZEND_STRS("expirationTime"), NULL },
	{ ZEND_STRS("issuerRiderFamily"), NULL },
	{ ZEND_STRS("issuerName"), NULL },
	{ ZEND_STRS("issuerXp"), NULL },
	{ ZEND_STRS("opponentName"), NULL },
	{ ZEND_STRS("removalCostResourceType"), NULL },
	{ ZEND_STRS("dragonInformation"), NULL },
	{ ZEND_STRS("lowestTile"), NULL },
	{ NULL, 0, NULL }
};

/** Interned */
const char *mongo_interned_amber = NULL;
const char *mongo_interned_y = NULL;
const char *mongo_interned_x = NULL;
const char *mongo_interned__id = NULL;
const char *mongo_interned_level = NULL;
const char *mongo_interned_type = NULL;
const char *mongo_interned_timestamp = NULL;
const char *mongo_interned_cost = NULL;
const char *mongo_interned_capacity = NULL;
...
{
	mongo_interned_names *interned_names = mongo_interned_names_list;

	MonGlo(log_level) = 0;
	MonGlo(log_module) = 0;

	MonGlo(global_null) = NULL;
	MonGlo(global_false) = NULL;
	MonGlo(global_true) = NULL;
	MonGlo(global_str) = NULL;
	MonGlo(global_array) = NULL;
	MonGlo(global_zero) = NULL;
	MonGlo(global_one) = NULL;
	MonGlo(global_two) = NULL;
	MonGlo(global_three) = NULL;

	do {
		interned_names->pointer = zend_new_interned_string(interned_names->name, interned_names->length, 0 TSRMLS_CC);
		++interned_names;
	} while (interned_names[0].name != NULL);
...
PHP_RSHUTDOWN_FUNCTION(mongo)
{
	if (MonGlo(global_null)) {
		zval_ptr_dtor(&MonGlo(global_null));
	}

	if (MonGlo(global_str)) {
		zval_ptr_dtor(&MonGlo(global_str));
	}

	if (MonGlo(global_array)) {
		zval_ptr_dtor(&MonGlo(global_array));
	}

	if (MonGlo(global_false)) {
		zval_ptr_dtor(&MonGlo(global_false));
	}

	if (MonGlo(global_true)) {
		zval_ptr_dtor(&MonGlo(global_true));
	}

	if (MonGlo(global_one)) {
		zval_ptr_dtor(&MonGlo(global_one));
	}

	if (MonGlo(global_two)) {
		zval_ptr_dtor(&MonGlo(global_two));
	}

	if (MonGlo(global_three)) {
		zval_ptr_dtor(&MonGlo(global_three));
	}

	if (MonGlo(global_zero)) {
		zval_ptr_dtor(&MonGlo(global_zero));
	}
